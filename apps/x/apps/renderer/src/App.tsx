              ...
              >
                {(selectedPath || isGraphOpen || isSuggestedTopicsOpen) && fileTabs.length >= 1 ? (
                  <TabBar
                    ...
                    allowSingleTabClose={fileTabs.length === 1 && (isGraphOpen || isSuggestedTopicsOpen || (selectedPath != null && (isBaseFilePath(selectedPath) || isFlashcardsTabPath(selectedPath) || isEssayReviewTabPath(selectedPath) || isDashboardTabPath(selectedPath))))}
                  />
                ) : (
                  <TabBar
                    tabs={chatTabs}
