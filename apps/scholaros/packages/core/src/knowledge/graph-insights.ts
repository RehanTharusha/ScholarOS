/** Adapted from nashsu/llm_wiki (GPL v3) — src/lib/graph-insights.ts (copied verbatim) */

import type { WikiGraphNode, WikiGraphEdge, CommunityInfo } from "./wiki-link-graph.js";
